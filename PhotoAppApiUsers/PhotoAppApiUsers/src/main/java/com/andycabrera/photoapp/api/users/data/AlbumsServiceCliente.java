...
@Component
class AlbumsFallbackFactory implements FallbackFactory<AlbumsServiceCliente> {

    @Override
    public AlbumsServiceCliente create(Throwable cause) {
...
class AlbumServiceClientFallback implements AlbumsServiceCliente{
